...
// PIXDate
#define COCOAPODS_POD_AVAILABLE_PIXDate
#define COCOAPODS_VERSION_MAJOR_PIXDate 0
#define COCOAPODS_VERSION_MINOR_PIXDate 1
#define COCOAPODS_VERSION_PATCH_PIXDate 0
